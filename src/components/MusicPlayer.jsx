...
export default function MusicPlayer() {
  ...
  return (
    <>
      ...
      {showSplash && (
        <div
          className={`fixed inset-0 z-[100] flex flex-col items-center justify-center bg-[#0F1E3D] transition-all duration-700 ${
        ...
        >
          ...
          <div className="absolute inset-0 overflow-hidden pointer-events-none">
            ...
            {/* Comet glow */}
            <div className="absolute top-[20%] right-[20%] w-96 h-96 rounded-full bg-[#E89B3C]/[0.1] blur-3xl"></div>
            <div className="absolute bottom-[30%] left-[15%] w-72 h-72 rounded-full bg-[#C48AB8]/[0.08] blur-3xl"></div>
            {/* Twilight gradient at bottom */}
            <div className="absolute bottom-0 left-0 w-full h-1/3 bg-gradient-to-t from-[#1E3058]/30 to-transparent"></div>
          </div>
          ...
          <div className="relative z-10 flex flex-col items-center gap-8 text-center px-6">
            ...
            <div className="space-y-3">
              <h1 className="text-3xl sm:text-4xl font-serif text-[#EDE8E0] font-light tracking-[0.15em]">
                YOSSY INDRA KUSUMA
              </h1>
              <div className="flex items-center justify-center gap-3">
                <span className="h-[1px] w-8 bg-[#E89B3C]/60"></span>
                <span className="font-mono text-[10px] text-[#8BA3C8] tracking-[0.3em] uppercase">
                  ポートフォリオ
                </span>
                <span className="h-[1px] w-8 bg-[#E89B3C]/60"></span>
              </div>
            ...
            <button
              ...
              className="group relative mt-6 px-10 py-4 rounded-full border border-[#E89B3C]/40 bg-transparent hover:bg-[#E89B3C]/10 hover:border-[#E89B3C]/80 transition-all duration-500 active:scale-95"
            >
              {/* Glow behind button */}
              <div className="absolute -inset-1 rounded-full bg-[#E89B3C]/10 blur-md opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>

              <div className="relative flex items-center gap-3">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" className="text-[#E89B3C]">
            ...
            {/* Music hint */}
            <p className="font-mono text-[9px] text-[#8BA3C8]/60 tracking-[0.2em] uppercase mt-2 animate-pulse">
            ...
            <div className="bg-zen-card/90 backdrop-blur-xl border border-zen-border rounded-lg px-3 py-3 shadow-lg">
              <input
                ...
                className="w-24 h-1 appearance-none bg-zen-border rounded-full outline-none cursor-pointer accent-zen-crimson
                  ...
                  [&::-webkit-slider-thumb]:shadow-[0_0_8px_rgba(232,155,60,0.5)]
